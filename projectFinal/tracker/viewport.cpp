...
void Viewport::draw(bool godMode, int numCatsLeft) const {
  ...
  IoMod::getInstance().writeText((godMode ? "GOD MODE: ENABLED" : "GOD MODE: DISBALED"),
    gdata.getXmlInt("text/godMode/locX")-1,
    gdata.getXmlInt("text/godMode/locY")+1,
    black);

  IoMod::getInstance().writeText((godMode ? "GOD MODE: ENABLED" : "GOD MODE: DISBALED"),
    gdata.getXmlInt("text/godMode/locX"),
    gdata.getXmlInt("text/godMode/locY"));
